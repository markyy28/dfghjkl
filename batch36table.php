...
<form method="POST"  action="batch36additem.php" style="margin-left:20px; margin-right:20px;">
<p style="font-size:16px; font-weight:bold;">V.4-DCP STATUS-BATCH 36 </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="name">School ID</label>
      <input  class="form-control full-width" type="text" name="batch36school_id" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Recipient School</label>
      <input class="form-control full-width" type="text" name="batch36rec" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="batch36" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">Year Funded</label>
      <input  class="form-control full-width" type="text" name="yearfund36" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Status(Functional/Defective/ForCondemn)</label>
      <input  class="form-control full-width" type="text" name="36status" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Package Content</label>
      <input  class="form-control full-width" type="text" name="packcon36" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="packrec36" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">No. Of Working Units</label>
      <input  class="form-control full-width" type="text" name="units36" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular defective parts) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="repair36" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Unit for Repair</label>
      <input  class="form-control full-width" type="text" name="specrepair36" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="repaircost36" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="replaces36" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification of Particular for Replacement</label>
      <input  class="form-control full-width" type="text" name="specreplace36" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="replacecost36" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="unrep36" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification Particular Unrepairable Part</label>
      <input  class="form-control full-width" type="text" name="specunrep36" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="unrepcost36" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular STOLEN UNITS) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="stolen36" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Stolen Unit</label>
      <input  class="form-control full-width" type="text" name="specstolen36" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="stolencost36" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="report36" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">If Yes, Please State the Date Reported</label>
      <input  class="form-control full-width" type="date" name="repdate36" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">If No, Please State the Reason</label>
      <input  class="form-control full-width" type="text" name="reason36" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      ...
      <input  class="form-control full-width" type="text" name="remarks36" placeholder="">
    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">V.4-DCP STATUS-BATCH 36</h4>
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
                      <th><?php echo $row["batch36school_id"] ?></th>
                      <th><?php echo $row["batch36rec"]  ?></th>
                      <th><?php echo $row["batch36"] ?></th>
                      <th><?php echo $row["yearfund36"]  ?></th>
                      <th><?php echo $row["36status"] ?></th>
                      <th><?php echo $row["packcon36"]  ?></th>
                      <th><?php echo $row["packrec36"]  ?></th>
                      <th><?php echo $row["units36"] ?></th>
                      <th><?php echo $row["repair36"]  ?></th>
                      <th><?php echo $row["specrepair36"] ?></th>
                      <th><?php echo $row["repaircost36"]  ?></th>
                      <th><?php echo $row["replaces36"]  ?></th>
                      <th><?php echo $row["specreplace36"] ?></th>
                      <th><?php echo $row["replacecost36"]  ?></th>
                      <th><?php echo $row["unrep36"] ?></th>
                      <th><?php echo $row["specunrep36"]  ?></th>
                      <th><?php echo $row["unrepcost36"]  ?></th>
                      <th><?php echo $row["stolen36"] ?></th>
                      <th><?php echo $row["specstolen36"]  ?></th>
                      <th><?php echo $row["stolencost36"] ?></th>
                      <th><?php echo $row["report36"]  ?></th>
                      <th><?php echo $row["repdate36"]  ?></th>
                      <th><?php echo $row["reason36"] ?></th>
                      <th><?php echo $row["remarks36"] ?></th>

                    
					  
					  <!-- <th> <a href="up"Edit</a><a href="dcpedit.php?id=<?php echo $row["batch36_id"] ?>">Edit</a> <a href="up"Edit</a><a href="delete.php?id=<?php echo $row["batch36_id"] ?>">Delete</a></th> -->
                      <th>
    <a href="javascript:void(0);" onclick="editWithPassword(<?php echo $row["batch36_id"] ?>)">Edit</a>
    <a href="javascript:void(0);" onclick="deleteWithPassword(<?php echo $row["batch36_id"] ?>)" style="color:red">Delete</a>
</th>
...
<head>
    ...
    function editWithPassword(dcpId) {
        ...
        */
        ...
        if (password === 'password') {
            // Password is correct, redirect to edit page
            window.location.href = 'batch36edit.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
    ...
    function deleteWithPassword(dcpId) {
        ...
        if (password === 'password') {
            ...
            window.location.href = 'batch36delete.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
