...
<form method="POST"  action="installadditem.php" style="margin-left:20px; margin-right:20px;">
<p style="font-size:16px; font-weight:bold;">INSTALLATION STATUS </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="name">School ID</label>
      <input  class="form-control full-width" type="text" name="installation_id" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Recipient School</label>
      <input class="form-control full-width" type="text" name="installrec" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="batchs" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">Installed (Yes/No)</label>
      <input  class="form-control full-width" type="text" name="ins" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Not Installed (Yes/No)</label>
      <input  class="form-control full-width" type="text" name="notins" placeholder="">
    </div>
  ...
  <div class="form-group col-md-6">
      ...
      <input  class="form-control full-width" type="text" name="remarks" placeholder="">
    </div>
                                        ...
                                        <table class="table text-dark text-center table-bordered table-striped">
                                            <thead class="text-uppercase">
                                                <tr style="font-size: 12px" class="table-active">
                                                    ...
                                                    <th scope="col">Install (Yes/No)</th>
                                                    <th scope="col">Not Install (Yes/No)</th>
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
                      <th><?php echo $row["installation_id"] ?></th>
                      <th><?php echo $row["installrec"]  ?></th>
                      <th><?php echo $row["batchs"] ?></th>
                      <th><?php echo $row["ins"]  ?></th>
                      <th><?php echo $row["notins"] ?></th>
                      <th><?php echo $row["remarks"]  ?></th>
                      
                   
                    
					  
					  <!-- <th> <a href="up"Edit</a><a href="dcpedit.php?id=<?php echo $row["install_id"] ?>">Edit</a> <a href="up"Edit</a><a href="delete.php?id=<?php echo $row["install_id"] ?>">Delete</a></th> -->
                      <th>
    <a href="javascript:void(0);" onclick="editWithPassword(<?php echo $row["install_id"] ?>)">Edit</a>
    <a href="javascript:void(0);" onclick="deleteWithPassword(<?php echo $row["install_id"] ?>)" style="color:red">Delete</a>
</th>
...
<head>
    ...
    function editWithPassword(installId) {
        ...
        */
        ...
        if (password === 'password') {
            // Password is correct, redirect to edit page
            window.location.href = 'installedit.php?id=' + installId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
    ...
    function deleteWithPassword(installId) {
        ...
        if (password === 'password') {
            ...
            window.location.href = 'installdelete.php?id=' + installId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
