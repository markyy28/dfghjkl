...
<form method="POST"  action="batch29additem.php" style="margin-left:20px; margin-right:20px;">
<p style="font-size:16px; font-weight:bold;">V.4-DCP STATUS-BATCH 29 </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="name">School ID</label>
      <input  class="form-control full-width" type="text" name="batch29school_id" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Recipient School</label>
      <input class="form-control full-width" type="text" name="batch29rec" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="batch290" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">Year Funded</label>
      <input  class="form-control full-width" type="text" name="yearfund29" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Status(Functional/Defective/ForCondemn)</label>
      <input  class="form-control full-width" type="text" name="29status" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Package Content</label>
      <input  class="form-control full-width" type="text" name="packcon29" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="packrec29" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">No. Of Working Units</label>
      <input  class="form-control full-width" type="text" name="units29" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular defective parts) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="repair29" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Unit for Repair</label>
      <input  class="form-control full-width" type="text" name="specrepair29" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="repaircost29" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="replaces29" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification of Particular for Replacement</label>
      <input  class="form-control full-width" type="text" name="specreplace29" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="replacecost29" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="unrep29" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification Particular Unrepairable Part</label>
      <input  class="form-control full-width" type="text" name="specunrep29" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="unrepcost29" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular STOLEN UNITS) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="stolen29" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Stolen Unit</label>
      <input  class="form-control full-width" type="text" name="specstolen29" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="stolencost29" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="report29" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">If Yes, Please State the Date Reported</label>
      <input  class="form-control full-width" type="date" name="repdate29" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">If No, Please State the Reason</label>
      <input  class="form-control full-width" type="text" name="reason29" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      ...
      <input  class="form-control full-width" type="text" name="remarks29" placeholder="">
    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">V.4-DCP STATUS-BATCH 29</h4>
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
                      <th><?php echo $row["batch29school_id"] ?></th>
                      <th><?php echo $row["batch29rec"]  ?></th>
                      <th><?php echo $row["batch290"] ?></th>
                      <th><?php echo $row["yearfund29"]  ?></th>
                      <th><?php echo $row["29status"] ?></th>
                      <th><?php echo $row["packcon29"]  ?></th>
                      <th><?php echo $row["packrec29"]  ?></th>
                      <th><?php echo $row["units29"] ?></th>
                      <th><?php echo $row["repair29"]  ?></th>
                      <th><?php echo $row["specrepair29"] ?></th>
                      <th><?php echo $row["repaircost29"]  ?></th>
                      <th><?php echo $row["replaces29"]  ?></th>
                      <th><?php echo $row["specreplace29"] ?></th>
                      <th><?php echo $row["replacecost29"]  ?></th>
                      <th><?php echo $row["unrep29"] ?></th>
                      <th><?php echo $row["specunrep29"]  ?></th>
                      <th><?php echo $row["unrepcost29"]  ?></th>
                      <th><?php echo $row["stolen29"] ?></th>
                      <th><?php echo $row["specstolen29"]  ?></th>
                      <th><?php echo $row["stolencost29"] ?></th>
                      <th><?php echo $row["report29"]  ?></th>
                      <th><?php echo $row["repdate29"]  ?></th>
                      <th><?php echo $row["reason29"] ?></th>
                      <th><?php echo $row["remarks29"] ?></th>

                    
					  
					  <!-- <th> <a href="up"Edit</a><a href="dcpedit.php?id=<?php echo $row["batch29_id"] ?>">Edit</a> <a href="up"Edit</a><a href="delete.php?id=<?php echo $row["batch29_id"] ?>">Delete</a></th> -->
                      <th>
    <a href="javascript:void(0);" onclick="editWithPassword(<?php echo $row["batch29_id"] ?>)">Edit</a>
    <a href="javascript:void(0);" onclick="deleteWithPassword(<?php echo $row["batch29_id"] ?>)" style="color:red">Delete</a>
</th>
...
<head>
    ...
    function editWithPassword(dcpId) {
        ...
        */
        ...
        if (password === 'password') {
            // Password is correct, redirect to edit page
            window.location.href = 'batch29edit.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
    ...
    function deleteWithPassword(dcpId) {
        ...
        if (password === 'password') {
            ...
            window.location.href = 'batch29delete.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
