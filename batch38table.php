...
<form method="POST"  action="batch38additem.php" style="margin-left:20px; margin-right:20px;">
<p style="font-size:16px; font-weight:bold;">V.4-DCP STATUS-BATCH 38  </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="name">School ID</label>
      <input  class="form-control full-width" type="text" name="batch38school_id" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Recipient School</label>
      <input class="form-control full-width" type="text" name="batch38rec" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="batch38" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">Year Funded</label>
      <input  class="form-control full-width" type="text" name="yearfund38" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Status(Functional/Defective/ForCondemn)</label>
      <input  class="form-control full-width" type="text" name="38status" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Package Content</label>
      <input  class="form-control full-width" type="text" name="packcon38" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="packrec38" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">No. Of Working Units</label>
      <input  class="form-control full-width" type="text" name="units38" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular defective parts) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="repair38" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Unit for Repair</label>
      <input  class="form-control full-width" type="text" name="specrepair38" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="repaircost38" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="replaces38" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification of Particular for Replacement</label>
      <input  class="form-control full-width" type="text" name="specreplace38" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="replacecost38" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="unrep38" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification Particular Unrepairable Part</label>
      <input  class="form-control full-width" type="text" name="specunrep38" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="unrepcost38" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular STOLEN UNITS) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="stolen38" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Stolen Unit</label>
      <input  class="form-control full-width" type="text" name="specstolen38" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="stolencost38" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="report38" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">If Yes, Please State the Date Reported</label>
      <input  class="form-control full-width" type="date" name="repdate38" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">If No, Please State the Reason</label>
      <input  class="form-control full-width" type="text" name="reason38" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      ...
      <input  class="form-control full-width" type="text" name="remarks38" placeholder="">
    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">V.4-DCP STATUS-BATCH 38</h4>
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
                      <th><?php echo $row["batch38school_id"] ?></th>
                      <th><?php echo $row["batch38rec"]  ?></th>
                      <th><?php echo $row["batch38"] ?></th>
                      <th><?php echo $row["yearfund38"]  ?></th>
                      <th><?php echo $row["38status"] ?></th>
                      <th><?php echo $row["packcon38"]  ?></th>
                      <th><?php echo $row["packrec38"]  ?></th>
                      <th><?php echo $row["units38"] ?></th>
                      <th><?php echo $row["repair38"]  ?></th>
                      <th><?php echo $row["specrepair38"] ?></th>
                      <th><?php echo $row["repaircost38"]  ?></th>
                      <th><?php echo $row["replaces38"]  ?></th>
                      <th><?php echo $row["specreplace38"] ?></th>
                      <th><?php echo $row["replacecost38"]  ?></th>
                      <th><?php echo $row["unrep38"] ?></th>
                      <th><?php echo $row["specunrep38"]  ?></th>
                      <th><?php echo $row["unrepcost38"]  ?></th>
                      <th><?php echo $row["stolen38"] ?></th>
                      <th><?php echo $row["specstolen38"]  ?></th>
                      <th><?php echo $row["stolencost38"] ?></th>
                      <th><?php echo $row["report38"]  ?></th>
                      <th><?php echo $row["repdate38"]  ?></th>
                      <th><?php echo $row["reason38"] ?></th>
                      <th><?php echo $row["remarks38"] ?></th>

                    
					  
					  <!-- <th> <a href="up"Edit</a><a href="dcpedit.php?id=<?php echo $row["batch38_id"] ?>">Edit</a> <a href="up"Edit</a><a href="delete.php?id=<?php echo $row["batch38_id"] ?>">Delete</a></th> -->
                      <th>
    <a href="javascript:void(0);" onclick="editWithPassword(<?php echo $row["batch38_id"] ?>)">Edit</a>
    <a href="javascript:void(0);" onclick="deleteWithPassword(<?php echo $row["batch38_id"] ?>)" style="color:red">Delete</a>
</th>
...
<head>
    ...
    function editWithPassword(dcpId) {
        ...
        */
        ...
        if (password === 'password') {
            // Password is correct, redirect to edit page
            window.location.href = 'batch38edit.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
    ...
    function deleteWithPassword(dcpId) {
        ...
        if (password === 'password') {
            ...
            window.location.href = 'batch38delete.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
