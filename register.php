                    ...
                    <div class="signup-form">
                        ...
                        <?php include('errors.php'); ?>
                         ...
                         <div class="form-group form-button">
                            <input style="background-color:#024589;" type="submit" name="reg_user" id="reg_user" class="form-submit" value="Register"/>
                            </div>
                        </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="images/back.png" alt="sing up image"></figure>
