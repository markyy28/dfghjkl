...
<form method="POST"  action="whiteadditem.php" style="margin-left:20px; margin-right:20px;">
<p style="font-size:16px; font-weight:bold;">UNBRANDED WHITE TABLET   </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="name">School ID</label>
      <input  class="form-control full-width" type="text" name="batchwschool_id" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Recipient School</label>
      <input class="form-control full-width" type="text" name="batchwrec" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="batchw" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">Year Funded</label>
      <input  class="form-control full-width" type="text" name="yearfundw" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Status(Functional/Defective/ForCondemn)</label>
      <input  class="form-control full-width" type="text" name="wstatus" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Package Content</label>
      <input  class="form-control full-width" type="text" name="packconw" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="packrecw" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">No. Of Working Units</label>
      <input  class="form-control full-width" type="text" name="unitsw" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular defective parts) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="repairw" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Unit for Repair</label>
      <input  class="form-control full-width" type="text" name="specrepairw" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="repaircostw" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="replacesw" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification of Particular for Replacement</label>
      <input  class="form-control full-width" type="text" name="specreplacew" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="replacecostw" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="unrepw" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification Particular Unrepairable Part</label>
      <input  class="form-control full-width" type="text" name="specunrepw" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="unrepcostw" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular STOLEN UNITS) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="stolenw" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Stolen Unit</label>
      <input  class="form-control full-width" type="text" name="specstolenw" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="stolencostw" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="reportw" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">If Yes, Please State the Date Reported</label>
      <input  class="form-control full-width" type="date" name="repdatew" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">If No, Please State the Reason</label>
      <input  class="form-control full-width" type="text" name="reasonw" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      ...
      <input  class="form-control full-width" type="text" name="remarksw" placeholder="">
    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">UNBRANDED WHITE TABLET  </h4>
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
                      <th><?php echo $row["batchwschool_id"] ?></th>
                      <th><?php echo $row["batchwrec"]  ?></th>
                      <th><?php echo $row["batchw"] ?></th>
                      <th><?php echo $row["yearfundw"]  ?></th>
                      <th><?php echo $row["wstatus"] ?></th>
                      <th><?php echo $row["packconw"]  ?></th>
                      <th><?php echo $row["packrecw"]  ?></th>
                      <th><?php echo $row["unitsw"] ?></th>
                      <th><?php echo $row["repairw"]  ?></th>
                      <th><?php echo $row["specrepairw"] ?></th>
                      <th><?php echo $row["repaircostw"]  ?></th>
                      <th><?php echo $row["replacesw"]  ?></th>
                      <th><?php echo $row["specreplacew"] ?></th>
                      <th><?php echo $row["replacecostw"]  ?></th>
                      <th><?php echo $row["unrepw"] ?></th>
                      <th><?php echo $row["specunrepw"]  ?></th>
                      <th><?php echo $row["unrepcostw"]  ?></th>
                      <th><?php echo $row["stolenw"] ?></th>
                      <th><?php echo $row["specstolenw"]  ?></th>
                      <th><?php echo $row["stolencostw"] ?></th>
                      <th><?php echo $row["reportw"]  ?></th>
                      <th><?php echo $row["repdatew"]  ?></th>
                      <th><?php echo $row["reasonw"] ?></th>
                      <th><?php echo $row["remarksw"] ?></th>

                    
					  
					  <!-- <th> <a href="up"Edit</a><a href="dcpedit.php?id=<?php echo $row["batchw_id"] ?>">Edit</a> <a href="up"Edit</a><a href="delete.php?id=<?php echo $row["batchw_id"] ?>">Delete</a></th> -->
                      <th>
    <a href="javascript:void(0);" onclick="editWithPassword(<?php echo $row["batchw_id"] ?>)">Edit</a>
    <a href="javascript:void(0);" onclick="deleteWithPassword(<?php echo $row["batchw_id"] ?>)" style="color:red">Delete</a>
</th>
...
<head>
    ...
    function editWithPassword(dcpId) {
        ...
        */
        ...
        if (password === 'password') {
            // Password is correct, redirect to edit page
            window.location.href = 'whiteedit.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
    ...
    function deleteWithPassword(dcpId) {
        ...
        if (password === 'password') {
            ...
            window.location.href = 'whitedelete.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
