...
<form method="POST"  action="batch19additem.php" style="margin-left:20px; margin-right:20px;">
<p style="font-size:16px; font-weight:bold;">V.4-DCP STATUS-BATCH 19 AND 23A </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="name">School ID</label>
      <input  class="form-control full-width" type="text" name="batch9school_id" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Recipient School</label>
      <input class="form-control full-width" type="text" name="batch9rec" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="batch9" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">Year Funded</label>
      <input  class="form-control full-width" type="text" name="yearfund9" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Status(Functional/Defective/ForCondemn)</label>
      <input  class="form-control full-width" type="text" name="9status" placeholder="">
    </div>
    <div class="form-group col-md-3">
      <label for="name">Package Content</label>
      <input  class="form-control full-width" type="text" name="packcon9" placeholder="">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input  class="form-control full-width" type="text" name="packrec9" placeholder="">
    </div>

    <div class="form-group col-md-3">
      <label for="name">No. Of Working Units</label>
      <input  class="form-control full-width" type="text" name="units9" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular defective parts) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="repair9" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Unit for Repair</label>
      <input  class="form-control full-width" type="text" name="specrepair9" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="repaircost9" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="replaces9" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification of Particular for Replacement</label>
      <input  class="form-control full-width" type="text" name="specreplace9" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="replacecost9" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="unrep9" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Specification Particular Unrepairable Part</label>
      <input  class="form-control full-width" type="text" name="specunrep9" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="unrepcost9" placeholder="">
    </div>
...
(Please encode number and  specfication of the particular STOLEN UNITS) </p>  
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="stolen9" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">Specification of Particular Stolen Unit</label>
      <input  class="form-control full-width" type="text" name="specstolen9" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">Estimated Cost</label>
      <input  class="form-control full-width" type="text" name="stolencost9" placeholder="">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input  class="form-control full-width" type="text" name="report9" placeholder="">
    </div>
    <div class="form-group col-md-4">
      <label for="name">If Yes, Please State the Date Reported</label>
      <input  class="form-control full-width" type="date" name="repdate9" placeholder="">
    </div>

    <div class="form-group col-md-4">
      <label for="name">If No, Please State the Reason</label>
      <input  class="form-control full-width" type="text" name="reason9" placeholder="">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      ...
      <input  class="form-control full-width" type="text" name="remarks9" placeholder="">
    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">V.4-DCP STATUS-BATCH 19 AND 23A</h4>
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
                      <th><?php echo $row["batch9school_id"] ?></th>
                      <th><?php echo $row["batch9rec"]  ?></th>
                      <th><?php echo $row["batch9"] ?></th>
                      <th><?php echo $row["yearfund9"]  ?></th>
                      <th><?php echo $row["9status"] ?></th>
                      <th><?php echo $row["packcon9"]  ?></th>
                      <th><?php echo $row["packrec9"]  ?></th>
                      <th><?php echo $row["units9"] ?></th>
                      <th><?php echo $row["repair9"]  ?></th>
                      <th><?php echo $row["specrepair9"] ?></th>
                      <th><?php echo $row["repaircost9"]  ?></th>
                      <th><?php echo $row["replaces9"]  ?></th>
                      <th><?php echo $row["specreplace9"] ?></th>
                      <th><?php echo $row["replacecost9"]  ?></th>
                      <th><?php echo $row["unrep9"] ?></th>
                      <th><?php echo $row["specunrep9"]  ?></th>
                      <th><?php echo $row["unrepcost9"]  ?></th>
                      <th><?php echo $row["stolen9"] ?></th>
                      <th><?php echo $row["specstolen9"]  ?></th>
                      <th><?php echo $row["stolencost9"] ?></th>
                      <th><?php echo $row["report9"]  ?></th>
                      <th><?php echo $row["repdate9"]  ?></th>
                      <th><?php echo $row["reason9"] ?></th>
                      <th><?php echo $row["remarks9"] ?></th>

                    
					  
					  <!-- <th> <a href="up"Edit</a><a href="dcpedit.php?id=<?php echo $row["batch19_id"] ?>">Edit</a> <a href="up"Edit</a><a href="delete.php?id=<?php echo $row["batch19_id"] ?>">Delete</a></th> -->
                      <th>
    <a href="javascript:void(0);" onclick="editWithPassword(<?php echo $row["batch19_id"] ?>)">Edit</a>
    <a href="javascript:void(0);" onclick="deleteWithPassword(<?php echo $row["batch19_id"] ?>)" style="color:red">Delete</a>
</th>
...
<head>
    ...
    function editWithPassword(dcpId) {
        ...
        */
        ...
        if (password === 'password') {
            // Password is correct, redirect to edit page
            window.location.href = 'batch19edit.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
    ...
    function deleteWithPassword(dcpId) {
        ...
        if (password === 'password') {
            ...
            window.location.href = 'batch19delete.php?id=' + dcpId;
        } else {
            alert("Incorrect password. Please try again.");
        }
    }
